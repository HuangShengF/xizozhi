...
namespace Lang {
    ...
    namespace Sounds {
        ...
        extern const char ogg_aec_off_start[] asm("_binary_aec_off_ogg_start");
        extern const char ogg_aec_off_end[] asm("_binary_aec_off_ogg_end");
        static const std::string_view OGG_AEC_OFF {
        static_cast<const char*>(ogg_aec_off_start),
        static_cast<size_t>(ogg_aec_off_end - ogg_aec_off_start)
        };

        extern const char ogg_aec_on_start[] asm("_binary_aec_on_ogg_start");
        extern const char ogg_aec_on_end[] asm("_binary_aec_on_ogg_end");
        static const std::string_view OGG_AEC_ON {
        static_cast<const char*>(ogg_aec_on_start),
        static_cast<size_t>(ogg_aec_on_end - ogg_aec_on_start)
        };

        extern const char ogg_audio_test_start[] asm("_binary_audio_test_ogg_start");
        extern const char ogg_audio_test_end[] asm("_binary_audio_test_ogg_end");
        static const std::string_view OGG_AUDIO_TEST {
        static_cast<const char*>(ogg_audio_test_start),
        static_cast<size_t>(ogg_audio_test_end - ogg_audio_test_start)
        };

        extern const char ogg_charge_start[] asm("_binary_charge_ogg_start");
        extern const char ogg_charge_end[] asm("_binary_charge_ogg_end");
        static const std::string_view OGG_CHARGE {
        static_cast<const char*>(ogg_charge_start),
        static_cast<size_t>(ogg_charge_end - ogg_charge_start)
        };

        extern const char ogg_clock_start[] asm("_binary_clock_ogg_start");
        extern const char ogg_clock_end[] asm("_binary_clock_ogg_end");
        static const std::string_view OGG_CLOCK {
        static_cast<const char*>(ogg_clock_start),
        static_cast<size_t>(ogg_clock_end - ogg_clock_start)
        };

        extern const char ogg_connect_start[] asm("_binary_connect_ogg_start");
        extern const char ogg_connect_end[] asm("_binary_connect_ogg_end");
        static const std::string_view OGG_CONNECT {
        static_cast<const char*>(ogg_connect_start),
        static_cast<size_t>(ogg_connect_end - ogg_connect_start)
        };

        extern const char ogg_disconnect_start[] asm("_binary_disconnect_ogg_start");
        extern const char ogg_disconnect_end[] asm("_binary_disconnect_ogg_end");
        static const std::string_view OGG_DISCONNECT {
        static_cast<const char*>(ogg_disconnect_start),
        static_cast<size_t>(ogg_disconnect_end - ogg_disconnect_start)
        };
        ...
        extern const char ogg_error_reset_start[] asm("_binary_error_reset_ogg_start");
        extern const char ogg_error_reset_end[] asm("_binary_error_reset_ogg_end");
        static const std::string_view OGG_ERROR_RESET {
        static_cast<const char*>(ogg_error_reset_start),
        static_cast<size_t>(ogg_error_reset_end - ogg_error_reset_start)
        };
        ...
        extern const char ogg_exitchat_start[] asm("_binary_exitchat_ogg_start");
        extern const char ogg_exitchat_end[] asm("_binary_exitchat_ogg_end");
        static const std::string_view OGG_EXITCHAT {
        static_cast<const char*>(ogg_exitchat_start),
        static_cast<size_t>(ogg_exitchat_end - ogg_exitchat_start)
        };

        extern const char ogg_factory_reset_start[] asm("_binary_factory_reset_ogg_start");
        extern const char ogg_factory_reset_end[] asm("_binary_factory_reset_ogg_end");
        static const std::string_view OGG_FACTORY_RESET {
        static_cast<const char*>(ogg_factory_reset_start),
        static_cast<size_t>(ogg_factory_reset_end - ogg_factory_reset_start)
        };
        ...
        extern const char ogg_network_4g_start[] asm("_binary_network_4g_ogg_start");
        extern const char ogg_network_4g_end[] asm("_binary_network_4g_ogg_end");
        static const std::string_view OGG_NETWORK_4G {
        static_cast<const char*>(ogg_network_4g_start),
        static_cast<size_t>(ogg_network_4g_end - ogg_network_4g_start)
        };

        extern const char ogg_network_wifi_start[] asm("_binary_network_wifi_ogg_start");
        extern const char ogg_network_wifi_end[] asm("_binary_network_wifi_ogg_end");
        static const std::string_view OGG_NETWORK_WIFI {
        static_cast<const char*>(ogg_network_wifi_start),
        static_cast<size_t>(ogg_network_wifi_end - ogg_network_wifi_start)
        };
        ...
        extern const char ogg_reboot_start[] asm("_binary_reboot_ogg_start");
        extern const char ogg_reboot_end[] asm("_binary_reboot_ogg_end");
        static const std::string_view OGG_REBOOT {
        static_cast<const char*>(ogg_reboot_start),
        static_cast<size_t>(ogg_reboot_end - ogg_reboot_start)
        };

        extern const char ogg_shutdown_start[] asm("_binary_shutdown_ogg_start");
        extern const char ogg_shutdown_end[] asm("_binary_shutdown_ogg_end");
        static const std::string_view OGG_SHUTDOWN {
        static_cast<const char*>(ogg_shutdown_start),
        static_cast<size_t>(ogg_shutdown_end - ogg_shutdown_start)
        };

        extern const char ogg_start_reset_start[] asm("_binary_start_reset_ogg_start");
        extern const char ogg_start_reset_end[] asm("_binary_start_reset_ogg_end");
        static const std::string_view OGG_START_RESET {
        static_cast<const char*>(ogg_start_reset_start),
        static_cast<size_t>(ogg_start_reset_end - ogg_start_reset_start)
        };
        ...
        extern const char ogg_volume_max_start[] asm("_binary_volume_max_ogg_start");
        extern const char ogg_volume_max_end[] asm("_binary_volume_max_ogg_end");
        static const std::string_view OGG_VOLUME_MAX {
        static_cast<const char*>(ogg_volume_max_start),
        static_cast<size_t>(ogg_volume_max_end - ogg_volume_max_start)
        };

        extern const char ogg_volume_min_start[] asm("_binary_volume_min_ogg_start");
        extern const char ogg_volume_min_end[] asm("_binary_volume_min_ogg_end");
        static const std::string_view OGG_VOLUME_MIN {
        static_cast<const char*>(ogg_volume_min_start),
        static_cast<size_t>(ogg_volume_min_end - ogg_volume_min_start)
        };

        extern const char ogg_wakeup_start[] asm("_binary_wakeup_ogg_start");
        extern const char ogg_wakeup_end[] asm("_binary_wakeup_ogg_end");
        static const std::string_view OGG_WAKEUP {
        static_cast<const char*>(ogg_wakeup_start),
        static_cast<size_t>(ogg_wakeup_end - ogg_wakeup_start)
        };
